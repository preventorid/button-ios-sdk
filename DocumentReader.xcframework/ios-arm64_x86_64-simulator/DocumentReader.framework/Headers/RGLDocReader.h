...
- (void)recognizeData:(NSData * _Nonnull)data
           completion:(RGLDocumentReaderCompletion _Nonnull)completion RGL_DEPRECATED(6.9, "Use `-[recognizeWithConfig:completion:]` instead.");
/**
 It's used for single frame processing where input is UIImage with a crop operation at the end.
 @param completion The block to execute after the recognition process finishes
 */
- (void)recognizeImageFromPresenter:(UIViewController * _Nonnull)presenter
                              image:(UIImage * _Nonnull)image
                         completion:(RGLDocumentReaderCompletion _Nonnull)completion RGL_DEPRECATED(6.9, "Use `-[recognizeImageFromPresenter:config:completion:]` instead.");
/**
...
- (void)recognizeImage:(UIImage * _Nonnull)image
            ...
            completion:(RGLDocumentReaderCompletion _Nonnull)completion RGL_DEPRECATED(6.9, "Use `-[recognizeWithConfig:completion:]` for `cameraMode:NO` or `-[recognizeVideoFrame:completion:]` for `cameraModeOn:YES` instead.");
/**
 It's used for multiple frames processing
 @param completion The block to execute after the recognition process finishes
 */
- (void)recognizeImages:(NSArray<UIImage *> *_Nonnull)images
             completion:(RGLDocumentReaderCompletion _Nonnull)completion RGL_DEPRECATED(6.9, "Use `-[recognizeWithConfig:completion:]` instead.");
/**
 It's used for multiple frames processing with RGLImageInput
 @param completion The block to execute after the recognition process finishes
 */
- (void)recognizeImagesWithImageInputs:(NSArray<RGLImageInput *> *_Nonnull)inputs
                            completion:(RGLDocumentReaderCompletion _Nonnull)completion RGL_DEPRECATED(6.9, "Use `-[recognizeWithConfig:completion:]` instead.");
/**
 It's used for multiple frames processing with RGLImageInput
 @param completion The block to execute after the recognition process finishes
...
- (void)showScanner:(UIViewController * _Nonnull)presenter
         completion:(RGLDocumentReaderCompletion _Nonnull)completion RGL_DEPRECATED(6.9, "Use `-[showScannerFromPresenter:config:completion:]` instead.");

...
#ifndef PALAMOFIRE_SWIFT_H
#define PALAMOFIRE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PAlamofire",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10PAlamofire15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(PAlamofire)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PAlamofire)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PAlamofire)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(PAlamofire)) <NSURLSessionTaskDelegate>
